...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare('INSERT INTO Orador (Nombre, Gmail, Contrasena, Calificacion) VALUES (?, ?, ?, ?)');

    // He añadido una calificación por defecto, por ejemplo, 0.00
    $calificacion = 0.00;

    // Cambié el tipo de los parámetros a 'sssd' para que coincidan con los tipos de datos.
    $stmt->bind_param('sssd', $nombre, $correo, $hashed_password, $calificacion);
